CUDA_VISIBLE_DEVICES=0,1,2,3 python train_net.py \
    ...
    DATASETS.TRAIN_TARGET_LIKE_LABEL "('target_like_cityscapes_foggy_train',)" \
    ...
    DATASETS.ADD_CROPS.SRC.TARGET_LIKE_CROP_IMG_DIR "datasets/target_like/c2fc/leftImg8bit/crops" \
    DATASETS.ADD_CROPS.SRC.NUM_CROPS 5 \
    DATASETS.ADD_CROPS.TGT.CROP_IMG_DIR "datasets/target_like/c2fc/leftImg8bit/crops" \

CUDA_VISIBLE_DEVICES=0,1,2,3 python train_net.py \
    ...
    OUTPUT_DIR exps/c2frost=5 \
    DATASETS.TRAIN_UNLABEL "('cityscapes_c_frost=5_train',)" \
    DATASETS.TEST "('cityscapes_fine_instance_seg_val','cityscapes_c_frost=5_val')" \
    DATASETS.TRAIN_TARGET_LIKE_LABEL "('target_like_cityscapes_c_frost=5_train',)" \

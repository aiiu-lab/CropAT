CUDA_VISIBLE_DEVICES=0,1 python train_net.py \
    ...
    OUTPUT_DIR exps/sunny2night_sunny \
    DATASETS.TRAIN_LABEL "('daytime_sunny_train',)" \
    DATASETS.TRAIN_UNLABEL "('night_sunny_train',)" \
    DATASETS.TRAIN_TARGET_LIKE_LABEL "('target_like_sunny2night_sunny_train',)" \
    DATASETS.TEST "('daytime_sunny_test','night_sunny_test')" \
    DATASETS.ADD_CROPS.SRC.CROP_IMG_DIR "datasets/sdgod/daytime_sunny/VOC2007/crops" \
    DATASETS.ADD_CROPS.SRC.ANNO_FILE_PATH None \
    DATASETS.ADD_CROPS.SRC.TARGET_LIKE_CROP_IMG_DIR "datasets/target_like/sunny2night_sunny/VOC2007/crops" \
    DATASETS.ADD_CROPS.SRC.NUM_CROPS 5 \
    DATASETS.ADD_CROPS.TGT.CROP_IMG_DIR "datasets/target_like/sunny2night_sunny/VOC2007/crops" \
